...
def beta_beat_dist(data_path, noise, estimator, mdx):
    ...
    tfs.write("rms_beta_beat_x_b1_pred.tfs", rms_beta_beat_x_b1_pred)
    rms_beta_beat_y_b1_pred = np.hstack(rms_y_b1_pred)
    tfs.write("rms_beta_beat_y_b1_pred.tfs", rms_beta_beat_y_b1_pred)
...
beta_beat_dist(data_path, noise, loaded_estimator, mdx)
